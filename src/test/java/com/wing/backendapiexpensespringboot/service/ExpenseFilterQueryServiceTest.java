...
class ExpenseFilterQueryServiceTest {
    ...
    @Test
    void getFilteredExpensesSortsByUpdatedAtThenCreatedAtThenDate() {
        String firebaseUid = "firebase-user-1";

        ExpenseEntity newestUpdated = expense(
                "a4fa62ed-dc6d-4e1e-b236-c67a6d907ff0",
                "2026-03-07T09:29:22.973Z",
                "2026-03-09T02:29:25",
                "2026-03-09T10:29:25");
        ExpenseEntity sameUpdatedNewerCreated = expense(
                "a3919ac3-514b-49a9-b908-9b6cf8ff9669",
                "2026-03-09T00:00:00Z",
                "2026-03-09T08:49:26",
                "2026-03-09T09:15:16");
        ExpenseEntity sameUpdatedOlderCreated = expense(
        ...
        assertEquals(List.of(
                newestUpdated.getId(),
                sameUpdatedNewerCreated.getId(),
                sameUpdatedOlderCreated.getId(),
                olderDay.getId()
